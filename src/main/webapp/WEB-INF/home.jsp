...
<div class="flex flex-row w-[100wh] h-[100vh] bg-white">
    <div class="w-[280px] bg-blue-300 flex flex-col items-center justify-start">
        ...
        <div class="text-center text-sm mb-6">
            ...
            <div class="font-medium text-blue-700"><%= account.getUsername()%></div>
        </div>
        <ul class="w-full px-6 flex-1">
            <li class="w-full flex items-center text-left my-2 px-2 py-1 hover:bg-blue-400 hover:rounded-lg hover:text-blue-100 hover:cursor-pointer">
                <a href="loan" target="main-frame" class="flex flex-row">
            ...
            <li class="w-full flex items-center text-left my-2 px-2 py-1 hover:bg-blue-400 hover:rounded-lg hover:text-blue-100 hover:cursor-pointer">
                <a href="category" target="main-frame" class="flex flex-row">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7">
            ...
            <% if (account.isAdmin()) { %>
            <li class="w-full flex items-center text-left my-2 px-2 py-1 hover:bg-blue-400 hover:rounded-lg hover:text-blue-100 hover:cursor-pointer">
                <a href="account" target="main-frame" class="flex flex-row">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7">
        ...
        <a href="" class="text-base font-medium text-blue-600 my-2 hover:text-blue-800" onclick="handleLogout()">Đăng xuất</a>
    </div>
    <iframe src="loan" name="main-frame" class="flex-1 w-[80%] bg-blue-100"></iframe>
</div>
<script>
    function handleLogout() {
        const xhr = new XMLHttpRequest();
        xhr.open('POST', 'auth?action=logout', true);
