                ...
                <form method="post" name="add" action="category?action=insert" onsubmit="return validateForm()">
                    <div class="flex flex-row w-[100%]">
                        <div class="w-[50%] flex flex-col mr-2 my-2">
                            ...
                            <input type="text" name="name" id="name" placeholder="Nhập tên danh mục" class="rounded-md px-3 py-2 mb-1" onkeyup="checkCategoryName()">
                            <span class="text-red-500 font-medium text-xs nameError"></span>
                        </div>
                    </div>
                    <div class="flex flex-row justify-end">
                        <input type="submit" value="Thêm danh mục" class="text-center mr-2 py-2 px-4 min-w-[200px] uppercase text-white bg-blue-500 hover:bg-blue-600 hover:cursor-pointer rounded-md font-semibold">
